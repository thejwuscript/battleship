...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _src_aiPlayer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/aiPlayer */ \"./src/aiPlayer.js\");\n/* harmony import */ var _src_gameBoard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/gameBoard */ \"./src/gameBoard.js\");\n/* harmony import */ var _src_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/player */ \"./src/player.js\");\n/* harmony import */ var _domHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./domHandler */ \"./src/domHandler.js\");\n\n\n\n\n\nconst Game = (() => {\n  const humanBoard = (0,_src_gameBoard__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const aiBoard = (0,_src_gameBoard__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const humanPlayer = (0,_src_player__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(aiBoard);\n  const aiPlayer = (0,_src_aiPlayer__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(humanBoard);\n\n  const humanGridDiv = document.querySelector(\".human-grid\");\n  const aiGridDiv = document.querySelector(\".ai-grid\");\n\n  const gameOver = () => {\n    return humanBoard.allShipsSunk() || aiBoard.allShipsSunk();\n  };\n\n  const gameLoop = (e) => {\n    const location = e.target.dataset.location.split(\",\");\n    humanPlayer.attack(location);\n    _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].updateAIGrid(aiBoard, location, e.target);\n    if (gameOver()) return _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].announceWinner('You win!');\n\n    aiPlayer.attack();\n    const aiSelection = aiPlayer.getLastAttackedLocation();\n    _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].updateHumanGrid(aiSelection)\n    if (gameOver()) return _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].announceWinner('You lose!');\n  };\n\n  const play = () => {\n    humanBoard.placeShips();\n    aiBoard.placeShips();\n    _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].render(humanBoard.getGrid(), humanGridDiv);\n    _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].render(aiBoard.getGrid(), aiGridDiv);\n    _domHandler__WEBPACK_IMPORTED_MODULE_3__[\"default\"].addListenersToCoordinates(gameLoop);\n  };\n\n  return { play };\n})();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Game);\n\n\n//# sourceURL=webpack://battleship/./src/game.js?");
